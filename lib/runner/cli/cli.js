...
class CliRunner {
  ...
  executeTestRunner(modules) {
    __writeLog('cli_runner_elxecute_test_runner', 'start');

    return this.testRunner.run(modules).then(res => {
      __writeLog('cli_runner_elxecute_test_runner', 'end');
  ...
  createTestRunner() {
    __writeLog('cli_create_test_runner', 'start');
    ...
    __writeLog('cli_create_test_runner', 'end');
    ...
    return this.runGlobalHook('before', [this.test_settings])
      ...
      .then(modules => {
        ...
        if (this.test_settings.selenium && this.test_settings.selenium.start_process) {
          __writeLog('load_selenium', 'start');
