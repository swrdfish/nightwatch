...
class LocateElement {
  ...
  executeProtocolAction(opts = {}) {
    ...
    __writeLog(`locator_excute_protocol_${transportAction}`, 'start');
    ...
    return this.sendElementsAction({transportAction, args, element, cacheElementId})
      ...
      .catch(error => {
        ...
        __writeLog(`locator_excute_protocol_${transportAction}`, 'end');
