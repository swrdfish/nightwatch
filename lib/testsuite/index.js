...
class TestSuite {
  ...
  runCurrentTest(testName) {
    ...
    __writeLog(`test_case_name::${testName}`, 'start');
    ...
    return this.createSession()
      ...
      .then(res => {
        __writeLog(`test_case_name::${testName}`, 'end');
  ...
  testCaseFinished() {
    ...
    return this.reporter.printTestResult().then(res => {
      __writeLog('testsuit_test_case_finished', 'end');
